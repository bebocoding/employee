# conftest.py fixtures is automatically imported in the package and sub-packages
...
# fixture is ran for every function (default)
...
def test_user(client):
    user_data = {"email": "bebo@gmail.com",
...
def test_user2(client):
    user_data = {"email": "mohsen@gmail.com",
                 "password": "password123"}
    res = client.post('/users/', json=user_data)
    assert res.status_code == 201  # 201 CREATED
    new_user = res.json()
